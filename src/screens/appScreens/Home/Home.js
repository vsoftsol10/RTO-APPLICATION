            ...
            <View style={styles.contentContainer}>
              ...
              <View style={styles.actionsContainer}>
                <TouchableOpacity
                  ...
                  onPress={() =>
                    navigation.navigate('DL', {applicationType: 'license'})
                  }>
                  <Text style={styles.buttonText}>Apply for License</Text>
                </TouchableOpacity>
                 {/* Change the second button (Apply for Learner) */}
                <TouchableOpacity
                  style={styles.primaryButton}
                  onPress={() =>
                    navigation.navigate('DL', {applicationType: 'learner'})
                  }>
              ...
              <View style={styles.infoCardsWrapper}>
                ...
                <View style={styles.arrowPaginationContainer}>
                  <TouchableOpacity
                    style={[
                      styles.arrowButton,
                      activeCardIndex === 0 && styles.disabledArrow,
                    ]}
                    ...
                    <Ionic
                      name="chevron-back"
                      size={24}
                      color={activeCardIndex === 0 ? '#cce8ea' : '#35cad1'}
                    />
                  </TouchableOpacity>

                  <View style={styles.pageIndicator}>
                    <Text style={styles.pageText}>
                      {activeCardIndex + 1}/{infoCards.length}
                    </Text>
                  </View>
                  ...
                  <TouchableOpacity
                    style={[
                      styles.arrowButton,
                      activeCardIndex === infoCards.length - 1 &&
                ...
                <TouchableOpacity
                  ...
                  <View style={styles.rtoCardContainer}>
                    ...
                    <View style={styles.rtoTextContainer}>
                      ...
                      <Text style={styles.rtoCardSubtitle}>
                        Rules made simple
                      </Text>
                    </View>
                  </View>
              ...
              <TouchableOpacity
                ...
                <Text style={styles.tipsDescription}>
                  Prepare for your driving test with these essential tips and
                  guidelines.
                </Text>
